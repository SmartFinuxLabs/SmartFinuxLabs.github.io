...
theme: default
paginate: true
header: 'Connextium.xyz — Investor Pitch Deck (15 Slides)'
footer: 'Confidential | Connextium.xyz © 2026'
style: |
  section {
  ...
  h1 { color: #0DBE85; font-size: 42px; margin-bottom: 16px; }
  h2 { color: #18201d; font-size: 30px; margin-bottom: 14px; }
  h3 { color: #0891b2; font-size: 24px; margin-bottom: 10px; }
  .highlight { color: #059669; font-weight: bold; }
  .stat { font-size: 38px; font-weight: 800; color: #0DBE85; }
---
...
<div style="display: flex; gap: 20px; margin-top: 14px; align-items: stretch;">
  ...
  <div style="flex: 1; display: flex; flex-direction: column; justify-content: space-between; gap: 12px;">
    ...
    <div style="background: white; border-left: 4px solid #e11d48; border-radius: 8px; padding: 14px 16px; border-top: 1px solid #e2e8f0; border-right: 1px solid #e2e8f0; border-bottom: 1px solid #e2e8f0;">
      ...
      <span style="font-size: 14.5px; line-height: 1.5; color: #475569;">Moving tokens wallet-to-wallet without double-entry controls breaks corporate treasury and audit compliance.</span>
    </div>
  </div>
...
### Capturing the Enterprise Shift to Programmable Liquidity

<div style="display: flex; justify-content: space-between; margin: 25px 0;">
  <div>
    <div class="stat">$150 T</div>
    <strong>Global B2B Payments (TAM)</strong>
    <p style="font-size: 16px; color: #64748b;">Annual enterprise cross-border cash flow</p>
  </div>
  <div>
    <div class="stat">$5.2 T</div>
    <strong>Supply Chain Finance (SAM)</strong>
    <p style="font-size: 16px; color: #64748b;">Unmet trade liquidity & factoring demand</p>
  </div>
  <div>
    <div class="stat">$25 B</div>
    <strong>Initial Target Volume (SOM)</strong>
    <p style="font-size: 16px; color: #64748b;">High-velocity cross-border trade corridors</p>
  </div>
</div>

**Platform + Application Playbook:**
1. **Build the Rail (Platform):** GTT payment and treasury router with automated stablecoin cash sweeps.
2. **Deploy Flagship App (SCF):** Verity dynamic discounting captures high transaction volume on Day 1.
3. **Expand Ecosystem (APIs):** Neobanks, logistics carriers, and fintechs build vertical applications on top.
...
- **Double-Entry Invariants:** Specialized financial ledgers guarantee zero-sum debit/credit balance constraints at 100k+ ops/sec.
...
![Corporate Treasury Structure Embedded with Stablecoins](../verity/assets/corporate-trasure-structure.png)
...
<!-- Slide 7: Dual T-Account Accounting & Real-Time ERP Sync -->
# Case Study: Dual T-Account Accounting & Real-Time ERP Sync
...
![ADA Accounting Framework Applied on Factoring Finance](../verity/assets/ADA-Framework-AccountOfDigitalAsset.png)
...
- **Project ADA / GTT Explorer:** [https://ada-alpha.connextium.xyz/](https://ada-alpha.connextium.xyz/)
  - Live on-chain payment router, multi-tenant double-entry inspector, and admin console.
...
- **Equity Offered:** **15.0%**
- **Valuation:** **Valuation round at $8.4 M** ($8,333,333 Post-Money)
...
- **Tørence Juhe** — Founder & Chief Architect / CEO
  - Strong background in building and improving finance and payments, from diverse banking projects servicing global Tier-1 banks (Singapore, Europe, Canada).
  - Studied Business Analytics & Data Science at Singapore Management University (SMU), and Finance Management.
- **Dr. Haroël Lee (Ph.D.)** — Co-Founder & Foundation Head Engineering
